...
{
    public ItemsSetViewModel ViewModel;

    public ItemsSetPage(AppDatabase appDatabase)
    {
        InitializeComponent();
        ViewModel = new ItemsSetViewModel(this, appDatabase);
    ...
    protected override async void OnNavigatedTo(NavigatedToEventArgs args)
    {
        ...
        await ViewModel.UpdateItemsFromDB();
    }
}
